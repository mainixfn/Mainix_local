...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "mianix.settings")
django.setup()
from pairtrade_stock.models import Kospi_StockName,Kosdaq_StockName
...
def Total_StockName_Dic(market):
    ...
    for i in range(len(category_business)):
